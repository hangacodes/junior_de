print("Hello world! Hello data engineering!")
print("This is day 1 of learning how to code")
print("This is a tiny program")
print("I am inside a .py file, wow")
...
#Example 2: Multiple lines run top to bottom
print("Line 1")
print("Line 2")
print("Line 3")
