...
print("\n")
print("═" * 80)
print("Section 2: Validation results")
print("-" * 25)
#Student 1
valid1 = True
#Age Validation:
...
if valid7:
    print(f"✓ {name7} - Age: {age7}, Grade: {grade7_f}%, City: {city7}")

print("\n")
print("═" * 80)
print("Section 3: Grade classifications")
print("-" * 25)
...
total_valid_records = int(valid1) + int(valid2) + int(valid3) + int(valid4) + int(valid5) + int(valid6) + int(valid7)
total_invalid_records = total_records_processed - total_valid_records
average_grade = (grade1_f + grade2_f + grade6_f) / total_valid_records
...
print(f"\nPassing (≥60%): 3 students")
print(f"Failing (<60%): 0 students")
